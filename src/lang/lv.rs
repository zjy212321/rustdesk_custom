...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Notiek savienojuma izveide ar UrekaGoDesk tīklu..."),
        ...
        ("install_tip", "UAC dēļ UrekaGoDesk dažos gadījumos nevar pareizi darboties kā attālā puse. Lai izvairītos no UAC, lūdzu, noklikšķiniet uz tālāk esošās pogas, lai instalētu UrekaGoDesk sistēmā."),
        ("Click to upgrade", "Jaunināt"),
        ("Click to download", "Lejupielādēt"),
        ("Click to update", "Atjaunināt"),
        ("Configure", "Konfigurēt"),
        ("config_acc", "Lai attālināti vadītu savu darbvirsmu, jums ir jāpiešķir UrekaGoDesk \"Pieejamība\" atļaujas."),
        ("config_screen", "Lai attālināti piekļūtu darbvirsmai, jums ir jāpiešķir UrekaGoDesk \"Ekrāna tveršana\" atļaujas."),
        ...
        ("android_input_permission_tip1", "Lai attālā ierīce varētu vadīt jūsu Android ierīci, izmantojot peli vai pieskārienu, jums ir jāatļauj UrekaGoDesk izmantot servisu \"Pieejamība\"."),
        ("android_input_permission_tip2", "Lūdzu, dodieties uz nākamo sistēmas iestatījumu lapu, atrodiet un atveriet [Instalētie pakalpojumi], ieslēdziet servisu [UrekaGoDesk Input]."),
        ...
        ("Turned off", "Izslēgts"),
        ("Language", "Valoda"),
        ("Keep RustDesk background service", "Saglabāt UrekaGoDesk fona servisu"),
        ("Ignore Battery Optimizations", "Ignorēt akumulatora optimizāciju"),
        ("android_open_battery_optimizations_tip", "Ja vēlaties atspējot šo funkciju, lūdzu, dodieties uz nākamo UrekaGoDesk lietojumprogrammas iestatījumu lapu, atrodiet un atveriet [Akumulators], noņemiet atzīmi no [Neierobežots]"),
        ...
        ("Show RustDesk", "Rādīt UrekaGoDesk"),
        ("This PC", "Šis dators"),
        ("or", "vai"),
        ...
        ("config_input", "Lai vadītu attālo darbvirsmu ar tastatūru, jums ir jāpiešķir UrekaGoDesk \"Ievades uzraudzība\" atļaujas."),
        ("config_microphone", "Lai runātu attālināti, jums ir jāpiešķir UrekaGoDesk \"Ierakstīt audio\" atļaujas."),
        ...
        ("still_click_uac_tip", "Joprojām attālajam lietotājam ir jānoklikšķina uz Labi UAC logā, kurā darbojas UrekaGoDesk."),
        ...
        ("verify_rustdesk_password_tip", "Pārbaudīt UrekaGoDesk paroli"),
        ...
        ("scam_text1", "Ja sarunājaties ar kādu, kuru nepazīstat un kurš ir lūdzis izmantot UrekaGoDesk, lai sāktu pakalpojumu, neturpiniet un nekavējoties nolieciet klausuli."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Lūdzu, jauniniet UrekaGoDesk Server Pro uz versiju {} vai jaunāku!"),
        ...
        ("selinux_tip", "Jūsu ierīcē ir iespējots SELinux, kas var neļaut UrekaGoDesk pareizi darboties kā kontrolētajai pusei."),
        ...
        ("powered_by_me", "Darbojas ar UrekaGoDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Atļaut savienojumu tikai tad, ja ir atvērts UrekaGoDesk logs"),
        ...
        ("floating_window_tip", "Tas palīdz uzturēt UrekaGoDesk fona servisu"),
        ...
        ("About UrekaGoDesk", "Par UrekaGoDesk"),
