...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Свързване с UrekaGoDesk мрежата..."),
        ...
        ("install_tip", "Поради UAC, UrekaGoDesk в някои случай не може да работи правилно за отдалечена достъп. За да заобиколите UAC, моля, натиснете копчето по-долу, за да поставите UrekaGoDesk като системна услуга."),
        ...
        ("config_acc", "За да управлявате вашия работна среда отдалечено, трябва да предоставите на UrekaGoDesk права от раздел \"Достъпност\"."),
        ("config_screen", "За да управлявате вашия работна среда отдалечено, трябва да предоставите на UrekaGoDesk права от раздел \"Запис на екрана\"."),
        ...
        ("Discovered", "Открит"),
        ("install_daemon_tip", "За зареждане при стартиране на ОС следва да поставите UrekaGoDesk като системна услуга."),
        ...
        ("android_input_permission_tip1", "За да може отдалечено устройство да управлява вашето Android устройство чрез мишка или допир, трябва да разрешите на UrekaGoDesk да използва услугата \"Достъпност\"."),
        ("android_input_permission_tip2", "Моля, отидете на следващата страница с системни настройки, намерете и въведете [Installed Services], включете услугата [UrekaGoDesk Input]."),
        ...
        ("Language", "Език"),
        ("Keep RustDesk background service", "Запази работеща фонова услуга с UrekaGoDesk"),
        ("Ignore Battery Optimizations", "Игнорирай оптимизациите на батерията"),
        ("android_open_battery_optimizations_tip", "Ако искате да деактивирате тази функция, моля, отидете на следващата страница с настройки на приложението UrekaGoDesk, намерете и въведете [Battery], премахнете отметката от [Unrestricted]"),
        ...
        ("Show RustDesk", "Покажи UrekaGoDesk"),
        ...
        ("config_input", "За да управлявате отдалечена среда с клавиатура, трябва да предоставите на UrekaGoDesk право за \"Input Monitoring\"."),
        ("config_microphone", "За да говорите отдалечено, трябва да предоставите на UrekaGoDesk право за \"Запис на звук\"."),
        ...
        ("still_click_uac_tip", "Все още изисква отдалеченият потребител да щракне върху OK в прозореца на UAC при стартиран UrekaGoDesk."),
        ...
        ("verify_rustdesk_password_tip", "Проверете UrekaGoDesk паролата"),
        ...
        ("scam_text1", "Ако разговаряте по телефона с някой, когото НЕ ПОЗНАВАТЕ и НЯМАТЕ ДОВЕРИЕ, който ви е помолил да използвате UrekaGoDesk и да стартирате услугата, не продължавайте и затворете незабавно."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Моля обновете UrekaGoDesk Server Pro на версия {} или по-нова!"),
        ...
        ("selinux_tip", "SELinux е активиран на вашето устройство, което може да попречи на UrekaGoDesk да работи правилно като контролирана страна."),
        ...
        ("About UrekaGoDesk", "Относно UrekaGoDesk"),
