...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till UrekaGoDesk..."),
        ...
        ("install_tip", "På grund av UAC, kan inte UrekaGoDesk fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera UrekaGoDesk på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge UrekaGoDesk \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge UrekaGoDesk \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [UrekaGoDesk Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep RustDesk background service", "Behåll UrekaGoDesk i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa UrekaGoDesk programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on boot", ""),
        ...
        ("Show RustDesk", "Visa UrekaGoDesk"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
