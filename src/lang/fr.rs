...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établi"),
        ("connecting_status", "Connexion au réseau UrekaGoDesk..."),
        ...
        ("config_acc", "Afin de pouvoir contrôler votre bureau à distance, veuillez donner l'autorisation \"accessibilité\" à UrekaGoDesk."),
        ("config_screen", "Afin de pouvoir accéder à votre bureau à distance, veuillez donner à UrekaGoDesk l'autorisation \"enregistrement d'écran\"."),
        ...
        ("android_input_permission_tip1", "Pour qu'un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher, vous devez autoriser UrekaGoDesk à utiliser le service \"Accessibilité\"."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, recherchez et entrez [Services installés], activez le service [UrekaGoDesk Input]."),
        ...
        ("Language", "Langue"),
        ("Keep RustDesk background service", "Gardez le service UrekaGoDesk en arrière plan"),
        ...
        ("Show RustDesk", "Afficher UrekaGoDesk"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Afin de contrôler le bureau à distance avec le clavier, vous devez accorder à UrekaGoDesk l'autorisation \"Surveillance de l’entrée\"."),
        ("config_microphone", "Pour discuter à distance, vous devez accorder à UrekaGoDesk les autorisations « Enregistrer l'audio »."),
        ...
        ("still_click_uac_tip", "Nécessite toujours que l'utilisateur distant confirme par la fenêtre UAC de UrekaGoDesk en cours d'éxécution."),
        ...
        ("verify_rustdesk_password_tip", "Vérifier le mot de passe UrekaGoDesk"),
        ...
        ("scam_text1", "Si vous êtes au téléphone avec quelqu'un QUE VOUS NE CONNAISSEZ PAS et en qui VOUS N'AVEZ PAS CONFIANCE et qui vous a demandé d'utiliser UrekaGoDesk et de démarrer le service, ne le faites pas et raccrochez immédiatement."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Veuillez mettre à jour UrekaGoDesk Server Pro avec la version {} ou une version plus récente !"),
        ...
        ("selinux_tip", "SELinux est activé sur votre appareil, ce qui peut empêcher UrekaGoDesk de fonctionner correctement en tant que machine contrôlé."),
        ...
        ("allow-only-conn-window-open-tip", "N’autoriser la connexion que si la fenêtre UrekaGoDesk est ouverte"),
