...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "UrekaGoDesk może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować UrekaGoDesk w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić UrekaGoDesk przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić UrekaGoDesk na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [UrekaGoDesk Input]."),
        ...
        ("Language", "Język"),
        ("Keep RustDesk background service", "Zachowaj usługę UrekaGoDesk w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji UrekaGoDesk, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show RustDesk", "Pokaż UrekaGoDesk"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji UrekaGoDesk uprawnień do \"Urządzeń Wejściowych\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z UrekaGoDesk w Twojej sieci."),
        ...
        ("verify_rustdesk_password_tip", "Weryfikuj hasło UrekaGoDesk"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu UrekaGoDesk - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Proszę zaktualizować UrekaGoDesk Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu UrekaGoDesk po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez UrekaGoDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno UrekaGoDesk jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę UrekaGoDesk w tle"),
